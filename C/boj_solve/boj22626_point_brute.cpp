...
Line L(const Pos& d, ld theta) {
	...
	ld vy = tan(theta);
	//std::cout << theta << " " << PI * .5 << " Line consist DEBUG\n";
...
int main() {
	...
	//std::cout << a1 << " " << a2 << " " << a3 << " " << a4 << " DEBUG\n";
	//Pos ax = IP(lp1, la); std::cout << ax.x << " " << ax.y << " DEBUG\n";
	//ax = IP(lp2, la); std::cout << ax.x << " " << ax.y << " DEBUG\n";
	//Line lx = L(IP(lp2, la), a2); std::cout << lx.vy << " " << lx.vx << " " << lx.c << " DEBUG\n";
	//Line ly = L(IP(lp2, la), a4); std::cout << ly.vy << " " << ly.vx << " " << ly.c << " DEBUG\n";
	...
	//std::cout << p1.x << " " << p1.y << " " << p2.x << " " << p2.y << " DEBUG\n";
