...
void get_area_memo(const Pos H[], ll memo[], const int& sz) {
	memo[0] = 0;
	for (int i = 0; i < sz; i++) {
...
int inner_check_bi_search(const Pos H[], const int& sz, const Pos& p) {
...
Info find_tangent_bi_search(const Pos H[], const int& sz, const Pos& p) {
	int i1{ 0 }, i2{ 0 };
...
Info get_inner_area(const Pos H[], const ll memo[], const int& sz, const Pos& p) {
...
ld find_inx_get_area_bi_search(const Pos H_in[], const ll memo_in[], const int& sz_in, const Pos H_out[], const ll memo_out[], const int& sz_out, const Pos& p) {
